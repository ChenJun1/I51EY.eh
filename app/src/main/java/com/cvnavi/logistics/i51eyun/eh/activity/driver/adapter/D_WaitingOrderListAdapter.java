...
//public class D_WaitingOrderListAdapter extends CommonAdapter<WaitingOrderBaseInfo> { // BaseAdapter
//
//	public D_WaitingOrderListAdapter(Context context, int layoutId, List<WaitingOrderBaseInfo> dataList) {
...
//				TextUtils.isEmpty(orderInfo.DeliveryTime) == true ? "--" : DateUtil.str2str(orderInfo.DeliveryTime));
//
...
//		SetViewValueUtil.setNumberValue((TextView) holder.getView(R.id.c_Weight_tv), orderInfo.Weight);
//		SetViewValueUtil.setNumberValue((TextView) holder.getView(R.id.c_Volume_tv), orderInfo.Volume);
//	}
//}


public class D_WaitingOrderListAdapter extends BaseAdapter {
	private HashMap<Integer, View> viewMaps = null;
	private LayoutInflater mInflater;
	private List<WaitingOrderBaseInfo> orderList;

	public D_WaitingOrderListAdapter(Context context, List<WaitingOrderBaseInfo> dataList) {
