 ...
 */
// public class D_ReceivedOrderListAdapter extends
// CommonAdapter<WaitingOrderBaseInfo> { // BaseAdapter
//
//
//
// public D_ReceivedOrderListAdapter(Context context, int layoutId,
// List<WaitingOrderBaseInfo> dataList) {
...
// holder.setText(R.id.c_DeliveryTime_tv,
// DateUtil.str2str(orderInfo.DeliveryTime));
//
// if (ContextUtil.isEnableOperate(orderInfo.Operate_Code,
// orderInfo.IsTHPhoto, orderInfo.IsJHPhoto,
// MyApplication.getInstatnce().getUserTypeOid())) {
// holder.getView(R.id.c_Operate_Code_btn).setVisibility(View.VISIBLE);
// holder.setText(R.id.c_Operate_Code_btn,
// ContextUtil.getOperateCodeContent(orderInfo.Operate_Code,
// orderInfo.IsTHPhoto, orderInfo.IsJHPhoto,
// MyApplication.getInstatnce().getUserTypeOid()));
// holder.setBackgroundRes(R.id.c_Operate_Code_btn,
// ContextUtil.getOperateStatusBg(orderInfo.Operate_Code,
// orderInfo.Order_Type));
//
// holder.getView(R.id.c_Operate_Code_tv).setVisibility(View.GONE);
// } else {
// holder.getView(R.id.c_Operate_Code_tv).setVisibility(View.VISIBLE);
// holder.setText(R.id.c_Operate_Code_tv,
// ContextUtil.getOperateCodeContent(orderInfo.Operate_Code,
// orderInfo.IsTHPhoto, orderInfo.IsJHPhoto,
// MyApplication.getInstatnce().getUserTypeOid()));
...
// orderInfo.Order_Type));
//
// holder.getView(R.id.c_Operate_Code_btn).setVisibility(View.GONE);
// }
//
// holder.setText(R.id.c_TotalFee_tv, orderInfo.TotalFee);
// SetViewValueUtil.setNumberValue((TextView) holder.getView(R.id.c_Number_tv),
// orderInfo.Number);
// SetViewValueUtil.setNumberValue((TextView) holder.getView(R.id.c_Weight_tv),
// orderInfo.Weight);
// SetViewValueUtil.setNumberValue((TextView) holder.getView(R.id.c_Volume_tv),
// orderInfo.Volume);
// }
// }

@SuppressLint("ViewHolder")
public class D_ReceivedOrderListAdapter extends BaseAdapter {
	private HashMap<Integer, View> viewMaps = null;
	private LayoutInflater mInflater;
	private List<WaitingOrderBaseInfo> orderList;

	private AdapterItemForTextViewCallBack callBack = null;

	public D_ReceivedOrderListAdapter(Context context, List<WaitingOrderBaseInfo> dataList,
			AdapterItemForTextViewCallBack callBack) {
...
//			convertView = mInflater.inflate(R.layout.d_order_item, null);
			...
			if (TextUtils.isEmpty(orderInfo.IsTHPhoto) == false && orderInfo.IsTHPhoto.equals("1")) {
				...
				c_Operate_Code_btn.setOnClickListener(new View.OnClickListener() {
					...
					public void onClick(View v) {
						callBack.onTextViewClick(position, orderInfo);
					}
				});
