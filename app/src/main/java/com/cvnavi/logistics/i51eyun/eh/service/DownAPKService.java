package com.cvnavi.logistics.i51eyun.eh.service;
...
public class DownAPKService extends Service {
	...
	public static String getStoragePath() {
		...
		if (exStorageState != null
			...
			// 如果外存储器不存在，则判断内存储器
			filePath = MyApplication.getInstatnce().getFilesDir();
		}
	...
	private static boolean isExitInternalStorage() {
		File file = MyApplication.getInstatnce().getFilesDir();
	...
	public static void installApk(String path) {
		...
		MyApplication.getInstatnce().startActivity(intent);
	}
}
