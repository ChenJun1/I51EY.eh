 ...
 */
public class D_MyEvaluateAdapter extends CommonAdapter<OrderEvaluationListInfo> {

	public D_MyEvaluateAdapter(Context context, int layoutId, List<OrderEvaluationListInfo> dataList) {
	...
	public void convert(ViewHolder holder, OrderEvaluationListInfo bean) {
		...
		// 货主得分为司机评价，司机得分为货主评价。
		holder.setText(R.id.my_score_tv, bean.HZPJ_SCORE); 
		holder.setText(R.id.driver_score_tv, bean.SJPJ_SCORE); 
	}
}
