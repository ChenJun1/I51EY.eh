...
@ContentView(R.layout.d_assess_details)
public class D_Assess_DedailsActivity extends BaseActivity {
					...
					public void onSuccess(String str) {
						...
						try {
							...
							if (resultBase.isSuccess()) {
								OrderEvaluationInfo bean = JsonUtils.parseData2(
										String.valueOf(resultBase.getDataValue()), OrderEvaluationInfo.class);
	...
	private Handler myHandler = new Handler() {
		...
		public void handleMessage(Message msg) {
			...
			case Constants.Request_Fail:
				alertDialog = new AlertDialog.Builder(D_Assess_DedailsActivity.this);
