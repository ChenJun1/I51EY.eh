package com.cvnavi.logistics.i51eyun.eh.widget.dialog;//package com.cvnavi.logistics.i51eyun.eh.widget.dialog;
//
//
...
//	 */
//	public CustomDialog(Context context, CharSequence msg, int type) {
//		super(context, R.style.Translucent_NoTitle);
//		this.context = context;
//		this.msg = msg;
//		this.type = type;
...
//	 */
//	public CustomDialog(Context context, CharSequence msg, CharSequence btnMsg, int type) {
//		super(context, R.style.Translucent_NoTitle);
//		this.context = context;
//		this.msg = msg;
//		this.type = type;
...
//	 */
//	public CustomDialog(Context context, CharSequence msg, CharSequence btnMsg) {
//		super(context, R.style.Translucent_NoTitle);
//		this.context = context;
//		this.msg = msg;
//		this.btnMsg = btnMsg;
