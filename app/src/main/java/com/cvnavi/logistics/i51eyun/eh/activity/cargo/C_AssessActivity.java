...
import com.cvnavi.logistics.i51eyun.eh.activity.cargo.adapter.C_MyEvaluateAdapter;
...
@ContentView(R.layout.c_assess)
public class C_AssessActivity extends BaseActivity implements OnRefreshListener {
	...
	private C_MyEvaluateAdapter adapter;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		titlt_textView.setText("我的评价");
		score_tv.setText(MyApplication.getInstatnce().getLoginData().getEvaluation_Score()+"分");
		refresh_layout.setOnRefreshListener(this);
		context = this;
		waitDialog = new CommonWaitDialog(context, R.style.progress_dialog);

		dataList = new ArrayList<OrderEvaluationListInfo>();
		adapter = new C_MyEvaluateAdapter(context, R.layout.c_assess_item, dataList);
	...
	private void onItemClick(AdapterView<?> parent, View view, int position, long id) {
		...
		Intent intent = new Intent(context, C_Assess_DedailsActivity.class);
