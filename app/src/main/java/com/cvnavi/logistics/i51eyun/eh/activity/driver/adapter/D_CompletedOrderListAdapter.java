 ...
 */
//public class D_CompletedOrderListAdapter extends CommonAdapter<WaitingOrderBaseInfo> { // BaseAdapter
//
//	public D_CompletedOrderListAdapter(Context context, int layoutId, List<WaitingOrderBaseInfo> dataList) {
...
public class D_CompletedOrderListAdapter extends BaseAdapter {
	private HashMap<Integer, View> viewMaps = null;
	private LayoutInflater mInflater;
	private List<WaitingOrderBaseInfo> orderList;

	public D_CompletedOrderListAdapter(Context context, List<WaitingOrderBaseInfo> dataList) {
